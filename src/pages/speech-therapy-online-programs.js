...
export default function Home() {
  ...
  return (
    <main>
      <Head>
        <title>Speech therapy online programs- annspech.com</title>
        ...
        <meta
          ...
          Adults!"
        />
        <meta name="keywords" content="speech therapy online programs" />
      </Head>
      ...
      <Container className={classes.mainDiv} maxWidth="lg">
        ...
        <Box spacing={3} className={classes.mainDiv}>
          <Typography
            ...
            gutterBottom
          >
            Looking for Speech Therapy Online Program - Overcome Speech Issues
            in 12 Weeks!
          </Typography>
