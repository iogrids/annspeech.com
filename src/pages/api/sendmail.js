...
async function sendMail(req, res) {
  ...
  if (patientType === 'Child' && conditionType !== 'Down Syndrome') {
  ...
  <html>
    ...
    <body class="" style="background-color: #f6f6f6; font-family: sans-serif; -webkit-font-smoothing: antialiased; font-size: 14px; line-height: 1.4; margin: 0; padding: 0; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;">
      <span class="preheader" style="color: transparent; display: none; height: 0; max-height: 0; max-width: 0; opacity: 0; overflow: hidden; mso-hide: all; visibility: hidden; width: 0;">Online Speech Therapy.</span>
  ...
  `;
  } else if (patientType === 'Child' && conditionType === 'Down Syndrome') {
    htmlToSend = `<!doctype html>
    <html>
      <head>
        <meta name="viewport" content="width=device-width">
                    ...
                    <td class="wrapper" style="font-family: sans-serif; font-size: 14px; vertical-align: top; box-sizing: border-box; padding: 20px;">
                      <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                        <tr>
                          <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                            <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">Hi {{firstName}},</p>
                            <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">Thank you for your response. I understand that you are looking for online speech therapy for your child with Down’s Syndrome and I am here to guide you.</p>
                            <p style="font-family: sans-serif; font-size: 14px; font-weight: bold; margin: 0; Margin-bottom: 15px;">The first step before intervention would be a detailed assessment. I am providing below the details of the same.</p>
                            <p style="font-family: sans-serif; font-size: 14px; font-weight: bold; margin: 0; Margin-bottom: 15px;">Detailed assessment (45 minutes- 1 hour)</p>
                            <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">&#8226;&#32;Collects case history</p>
                            <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">&#8226;&#32;Brief history including feeding history after birth.</p>
                            <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">&#8226;&#32;Current oral motor and feeding skills of the child.</p>
                            <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">&#8226;&#32;Receptive( understanding) and expressive(speaking) language skills of the child.</p>
                            <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">Following the assessment, the findings and the treatment plan will be discussed. The nature of therapy and the number of sessions required per week will be discussed.</p>
                            <p style="font-family: sans-serif; font-size: 14px; font-weight: bold; margin: 0; Margin-bottom: 15px;">Therapy sessions (45 minutes each)</p>
                            <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">An orientation to Oral Placement Therapy (OPT) and how it benefits your child will be discussed. I will provide you with all the training and guidance that is required for you to effectively carry out OPT exercises at home and how to transition these muscle movements to speech.</p>
                            <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">Therapy sessions will be conducted through Zoom or Google meet.</p>
                            <p style="font-family: sans-serif; font-size: 14px; font-weight: bold; margin: 0; Margin-bottom: 15px;">My qualification and experience are given below:</p>
                            <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">I am a certified and licensed Speech and Language Pathologist with Master’s degree in Audiology and Speech Language Pathology. In my professional career I have provided assessment and treatment for numerous children with speech and language delay, communication and feeding issues associated with Autism, Attention Deficit Hyperactivity Disorders, Down's Syndrome, stuttering/stammering, Cleft Lip and Palate, other developmental disorders and so on. I am a certified Oral Placement Therapist (Level 2). Other certifications include Feeding Therapy: A Sensory Motor Approach and A Sensory Motor Approach to Apraxia of speech. I am registered with Rehabilitation Council of India.</p>
                            <p style="font-family: sans-serif; font-size: 14px; font-weight: bold; margin: 0; Margin-bottom: 15px;">Please respond to this mail if you would like go ahead and I will get back to you with the charges for assessment and therapy.</p>
                    ...
                    <td class="wrapper" style="font-family: sans-serif; font-size: 14px; vertical-align: top; box-sizing: border-box; padding: 20px;">
                      <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                        <tr>
                          <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                            <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">Hi {{firstName}},</p>
                            <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">I understand that you are having concerns regarding your communication skills and I am here to help you.</p>
                            <p style="font-family: sans-serif; font-size: 14px; font-weight: bold; margin: 0; Margin-bottom: 15px;">I am providing below the services that I offer.</p>
                            <p style="font-family: sans-serif; font-size: 14px; font-weight: bold; margin: 0; Margin-bottom: 15px;">Detailed assessment (45 minutes- 1 hour)</p>
                            <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">&#8226;&#32;Collects case history</p>
                            <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">&#8226;&#32;Detailed evaluation of stuttering/stammering/pronunciation issues when required</p>
                            <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">&#8226;&#32;Current communication skills and strengths</p>
                            <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">&#8226;&#32;Specific assessment procedure using appropriate test materials for communication difficulties associated with stroke, Parkinson’s disease, dementia, voice disorders and other adult communication issues.</p>
                            <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">Following this, findings from the assessment and the nature of intervention approach best suitable for the client will be discussed. Also the approximate number of sessions per week that would be necessary for the client to progress will be discussed.</p>
                            <p style="font-family: sans-serif; font-size: 14px; font-weight: bold; margin: 0; Margin-bottom: 15px;">Therapy sessions (45 minutes each)</p>
                            <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">Therapy sessions will be conducted through Zoom or Google meet.</p>
                            <p style="font-family: sans-serif; font-size: 14px; font-weight: bold; margin: 0; Margin-bottom: 15px;">My qualification and experience are given below:</p>
                            <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">I am a certified and licensed Speech and Language Pathologist with Master’s degree in Audiology and Speech Language Pathology. In my professional career I have provided assessment and treatment for numerous children with speech and language delay, communication and feeding issues associated with Autism, Attention Deficit Hyperactivity Disorders, Down's Syndrome, stuttering/stammering, Cleft Lip and Palate, other developmental disorders and so on. I am a certified Oral Placement Therapist (Level 2). Other certifications include Feeding Therapy: A Sensory Motor Approach and A Sensory Motor Approach to Apraxia of speech. I am registered with Rehabilitation Council of India.</p>
  ...
  htmlToSend = htmlToSend.replace('{{firstName}}', req.body.fullname);
