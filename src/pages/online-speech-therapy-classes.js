...
export default function Home() {
  ...
  return (
    <main>
      <Head>
        <title>Online speech therapy classes - annspech.com</title>
        ...
        <meta
          ...
          Adults!"
        />
        <meta name="keywords" content="online speech therapy classes" />
      </Head>
      ...
      <Container className={classes.mainDiv} maxWidth="lg">
        ...
        <Box spacing={3} className={classes.mainDiv}>
          <Typography
            ...
            gutterBottom
          >
            Online Speech Therapy Classes - Overcome Speech Issues in 12 Weeks!
          </Typography>
